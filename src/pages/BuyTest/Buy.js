...
export default class Buy extends React.Component
{
    constructor(props)
    {
        ...
        this.state = {
            ...
            addressBech32SendADA: "addr1qyf9u2cfxhlkhyxywc0kf05zzkgcjv8vvdpr0q6qz3437yk2awc00p8qns6lmmxnw3zrresd34vafvj2yasa7xyr7cqsqh3dev",
                ...
                <Tabs id="TabsExample" vertical={true} onChange={this.handleTabId} selectedTabId={this.state.selectedTabId}>
                    <Tab id="1" title="" panel={
                        <div style={{marginLeft: "20px"}}>
                            ...
                            <button style={{padding: "10px", color:"violet", background:"gray", fontSize:"20px"}} onClick={this.buildSendADATransaction}>BUY CARDAMON</button>
                        </div>
                    } />
